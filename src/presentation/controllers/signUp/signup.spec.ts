...
describe('SignUp Controller', () => {
  ...
  it('should return error 400 if no password is provided', () => {
    const { sut } = makeSut()
  ...
  it('should return error 400 if no password confirmation is provided', () => {
    const { sut } = makeSut()
  ...
  it('should return error 400 if no password confirmation fails', () => {
    const { sut } = makeSut()
  ...
  it('should return error 400 if is an invalid email is provided', () => {
